...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        public void Update() {
            ...
            // 少なくとも1つの平面をトラッキングしているときは、スナックバーを非表示にします。
            ...
            // プレーヤーが画面に触れていない場合は、このアップデートが完了しています。
            Touch touch;
            ...
            // プレイヤーがタッチして平面を検索した場所に対するレイキャスト。
            // TrackableHit hit;
            ...
            if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit)) {
                ...
                // ヒットポーズとカメラポーズを使用してヒットテストがプレーンの後ろにあるかどうかを確認します。そうであれば、アンカーを作成する必要はありません。
